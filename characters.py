...
database.addMany([
{
  ...
  "habilidades": {
    "talentos": {
      ...
      "manha": { "valor": 1, "especializacoes": [] },
      "labia": { "valor": 1, "especializacoes": [] },
    },
    "pericias": {
...
},
{
  ...
  "quintessencia": 2,
  "paradoxo": 0,
  "antecedentes": [{"arcanum":5}, {"avatar":2}],
  "atributos": {
    "forca": { "valor": 3, "especializacoes": [] },
    "destreza": { "valor": 4, "especializacoes": [] },
    "vigor": { "valor": 3, "especializacoes": [] },
    "carisma": { "valor": 2, "especializacoes": [] },
    "manipulacao": { "valor": 2, "especializacoes": [] },
    "aparencia": { "valor": 2, "especializacoes": [] },
    "percepcao": { "valor": 3, "especializacoes": [] },
    "inteligencia": { "valor": 2, "especializacoes": [] },
    "raciocinio": { "valor": 3, "especializacoes": [] },
  },
  "habilidades": {
    "talentos": {
      "prontidao": { "valor": 3, "especializacoes": [] },
      "esportes": { "valor": 3, "especializacoes": [] },
      "consciencia": { "valor": 0, "especializacoes": [] },
      "briga": { "valor": 3, "especializacoes": [] },
      "esquiva": { "valor": 1, "especializacoes": [] },
      "expressao": { "valor": 0, "especializacoes": [] },
      "intimidacao": { "valor": 2, "especializacoes": [] },
      "lideranca": { "valor": 0, "especializacoes": [] },
      "manha": { "valor": 1, "especializacoes": [] },
    ...
    "pericias": {
      ...
      "conducao": { "valor": 0, "especializacoes": [] },
      "etiqueta": { "valor": 0, "especializacoes": [] },
      "armas_de_fogo": { "valor": 4, "especializacoes": ["armas leves"] },
      "meditacao": { "valor": 0, "especializacoes": [] },
      "armas_brancas": { "valor": 3, "especializacoes": [] },
      "atuacao": { "valor": 0, "especializacoes": [] },
      "furtividade": { "valor": 3, "especializacoes": [] },
      "sobrevivencia": { "valor": 0, "especializacoes": [] },
      "tecnologia": { "valor": 0, "especializacoes": [] },
    },
    "conhecimentos": {
      "academicos": { "valor": 0, "especializacoes": [] },
      "computador": { "valor": 0, "especializacoes": [] },
      "cosmologia": { "valor": 0, "especializacoes": [] },
      "enigmas": { "valor": 1, "especializacoes": [] },
      "investigacao": { "valor": 2, "especializacoes": [] },
      "direito": { "valor": 0, "especializacoes": [] },
      "linguistica": { "valor": 0, "especializacoes": [] },
      "medicina": { "valor": 0, "especializacoes": [] },
      "ocultismo": { "valor": 2, "especializacoes": [] },
      "ciencias": { "valor": 0, "especializacoes": [] },
    },
  },
  "esferas": {
    "correspondencia": { "valor": 1, "especializacoes": [] },
    "entropia": { "valor": 2, "especializacoes": [] },
    "forcas": { "valor": 1, "especializacoes": [] },
    "vida": { "valor": 0, "especializacoes": [] },
    "mente": { "valor": 0, "especializacoes": [] },
    "materia": { "valor": 0, "especializacoes": [] },
    "primordio": { "valor": 2, "especializacoes": [] },
    "espirito": { "valor": 0, "especializacoes": [] },
    "tempo": { "valor": 0, "especializacoes": [] },
  },
}
])